...
export default () => {
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            {
                const { data } = await axios.post("http://localhost:4000/api/upload", lFile, {
                    headers: {
            ...
            {
                const { data } = await axios.post("http://localhost:4000/api/upload", cFile, {
                    headers: {
                        "content-type": "multipart/form-data"
                    }
                });
    ...
    const onClickPost = async e => {
        try {
            ...
            {
                const { data } = await axios.post("http://localhost:4000/api/upload", file, {
                    headers: {
                    "content-type": "multipart/form-data"
                    }
                });
